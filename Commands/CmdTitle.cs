...
namespace MCForge
{
    public class CmdTitle : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (who.name != p.name && p.group.Permission < LevelPermission.Operator) { Player.SendMessage(p, "You are not allowed to change another players title!"); return; }
            ...
            if (newTitle.Length > 30) { Player.SendMessage(p, "Title must be under 17 letters."); return; }
