            ...
            try
            {
                ...
                switch (message)
                {
                    case "":
                        ...
                        {
                            Player.SendMessage(p, "Use &b/help zombie" + Server.DefaultColor + " for a list of zombie commands.");
                    ...
                    case "zombie":
                        ...
                        foreach (Command comm in Command.all.commands)
                        {
                            ...
                            {
                                if (comm.type.Contains("zombie")) message += ", " + getColor(comm.name) + comm.name;
                            }
                        }

                        if (message == "") { Player.SendMessage(p, "No commands of this type are available to you."); break; }
                        Player.SendMessage(p, "Zombie commands you may use:");
