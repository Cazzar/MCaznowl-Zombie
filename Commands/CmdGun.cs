...
namespace MCForge
{
    public class CmdGun : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (!p.referee) { Player.SendMessage(p, "You must be a referee to use this command!"); return; }
        ...
        {
            Player.SendMessage(p, "/gun [at end] - Allows you to fire a bullet that will TP to where it hits.");
        }
