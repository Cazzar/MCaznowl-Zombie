...
namespace MCForge
{
    public class CmdShank : Command
    {
        public override string name { get { return "shank"; } }
        ...
        public override void Use(Player p, string message)
        {
            ...
            Player.GlobalMessage(color + giver + " " + Server.DefaultColor + "shanks " + player1.color + player1.name);
        }

        // This one controls what happens when you use /help [commandname].
        public override void Help(Player p)
        {
            Player.SendMessage(p, "/shank - Shank someone");
        }
    }
}